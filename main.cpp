...
void DEntry(PVOID) {
	...
	BYTE devi[] = { '\\', '\0', 'D', '\0', 'e', '\0', 'v', '\0', 'i', '\0', 'c', '\0', 'e', '\0', '\\', '\0', 'A', '\0', 's', '\0', 'e', '\0', 'r', '\0', 'o', '\0', 'x', '\0', 'E', '\0', 'Z', '\0', 'Z', '\0', '\0', '\0', '\0', '\0' };
	BYTE dospath[] = { '\\', '\0', 'D', '\0', 'o', '\0', 's', '\0', 'D', '\0', 'e', '\0', 'v', '\0', 'i', '\0', 'c', '\0', 'e', '\0', 's', '\0', '\\', '\0', 'A', '\0', 's', '\0', 'e', '\0', 'r', '\0', 'o', '\0', 'x', '\0', 'E', '\0', 'Z', '\0', 'Z','\0','\0','\0','\0', '\0' } ;
